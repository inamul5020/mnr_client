      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div>
              ...
              <p className="text-sm text-gray-500">Optimized for A4 printing</p>
            </div>
          </div>
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-80px)]">
          <div className="p-8 print-content">
            ...
            {/* Page 2 - Tax Years & Company Details */}
            <div className="print-page">
              <div className="print-header">
                <div className="company-name">{client.legalName}</div>
                <div className="print-date">Tax & Company Information - {printDate}</div>
              </div>
